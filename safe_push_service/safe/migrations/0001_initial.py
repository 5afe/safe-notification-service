...
import safe_push_service.safe.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.CharField(max_length=42, primary_key=True, serialize=False, validators=[safe_push_service.safe.models.validate_checksumed_address], verbose_name='owner')),
            ],
            options={
                'verbose_name': 'device',
